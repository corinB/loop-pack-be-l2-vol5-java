...
- [x] PR 02: 브랜드·상품 운영·조회와 선행 Like 저장 구조 완료 및 병합(PR #7)
- [x] PR 03: 좋아요 등록·취소·목록 완료 및 병합(PR #8)
- [x] PR 04: 포인트·기록·초기 잔액 연결 완료 및 병합(PR #9)
- [x] PR 05: 주문 생성·조회와 결제 조회 구조 완료 및 병합(PR #10)
- [ ] PR 06: 주문 확정·전체 롤백·순차 재확정 검증 구현·검사 완료, 병합 대기(PR #11)
